...
----
$ git clone git@github.com:lholmquist/new-node-1
...
. Stop your booster.
. Make your change (e.g. edit link:https://github.com/lholmquist/new-node-1/edit/master/{fileLocation}[`{fileLocation}`]).
